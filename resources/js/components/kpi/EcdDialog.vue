    ...
    >
        <v-card class="rounded-lg" minHeight="300">
            <v-row class="ma-0 pa-0">
                <div
                    :class="`v-col-12 ${
                        ecdOptions.is_review == true ? 'v-col-md-8' : ''
                    } px-4`"
                >
                    <v-row>
            ...
            <div class="v-col-12 v-col-md-12 py-0 px-1">
              ...
              ></v-text-field>
                    ...
                    <v-row v-else>
                        <div class="v-col-12 py-5 mt-5">
                            <h3
                                :class="`${
                                    ecdData.achievement_yearend >= 1
                                        ? 'text-success'
                                        : 'text-error'
                                } text-center`"
                            >
                                {{
                                    ecdData.achievement_yearend
                                        ? ratingTitle(
                                              ecdData.achievement_yearend
                                          )
                                        : ""
...
const ecdAchievement = ref([
    {
        title: "5 - Skill level improved drastically & widely noticed",
        value: 5,
    },
...
const ratingTitle = (v) => {
    if (v > 5) {
        return "Skill level improved drastically & widely noticed";
    } else if (v >= 4) {
        return "Improvement is noticed";
    } else if (v >= 3) {
        return "Marginal improvement in skills";
    } else if (v >= 2) {
        return "Very slight Improvement";
    } else if (v >= 1) {
        return "No Improvement at all";
    } else {
        return "Didn`t attend the training";
    }
};
