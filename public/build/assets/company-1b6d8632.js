<<<<<<< HEAD:public/build/assets/company-977fc0bb.js
<<<<<<< HEAD:public/build/assets/company-455c1dd0.js
...
=======
import{a3 as e}from"./app-21392993.js";import{c as i}from"./clientApi-109b0c11.js";const n=e("company",{state:()=>({company_list:[]}),getters:{companies:t=>t.company_list,active_companies:t=>t.company_list.filter(a=>a.status==="active")},actions:{async getCompanies(t){await i(t).get("/api/companies").then(a=>{this.company_list=a.data})}}});export{n as u};
>>>>>>> phase-1:public/build/assets/company-977fc0bb.js
=======
import{a3 as e}from"./app-bbfc2b42.js";import{c as i}from"./clientApi-087d8690.js";const n=e("company",{state:()=>({company_list:[]}),getters:{companies:t=>t.company_list,active_companies:t=>t.company_list.filter(a=>a.status==="active")},actions:{async getCompanies(t){await i(t).get("/api/companies").then(a=>{this.company_list=a.data})}}});export{n as u};
>>>>>>> phase-1:public/build/assets/company-1b6d8632.js
